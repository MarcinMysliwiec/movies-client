...
function FilterMovies ({ showMoviesOnBtn }) {
  return (
    <div className="navlink-container">
      <button onClick={() => showMoviesOnBtn('popular')} className="filter-btn" id="popular">
        <TrendingSvg className="popular" alt="popular"/>
        Popular
      </button>
      <button onClick={() => showMoviesOnBtn('top_rated')} className="filter-btn" id="top-rated">
        <StarSvg className="top_rated" alt="top rated"/>
        Top <br/>
        Rated
      </button>
      <button onClick={() => showMoviesOnBtn('now_playing')} className="filter-btn" id="now-playing">
